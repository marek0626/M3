...
trace_op_t trace_ops_tar[] = {
    ...
    /* #6 = 0x6 */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar" } },
    ...
    /* #22 = 0x16 */ { .opcode = OPEN_OP, .args.open = { 4, "/fstrace/tar", O_RDONLY|O_NONBLOCK|O_DIRECTORY|O_CLOEXEC, 0 } },
    ...
    /* #27 = 0x1b */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/4096.bin" } },
    /* #28 = 0x1c */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 2399 } },
    /* #29 = 0x1d */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/4096.bin", O_RDONLY, 0 } },
    ...
    /* #37 = 0x25 */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/128.bin" } },
    /* #38 = 0x26 */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 7825 } },
    /* #39 = 0x27 */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/128.bin", O_RDONLY, 0 } },
    ...
    /* #47 = 0x2f */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/512.bin" } },
    /* #48 = 0x30 */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 6623 } },
    /* #49 = 0x31 */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/512.bin", O_RDONLY, 0 } },
    ...
    /* #57 = 0x39 */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/1024.bin" } },
    /* #58 = 0x3a */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 6727 } },
    /* #59 = 0x3b */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/1024.bin", O_RDONLY, 0 } },
    ...
    /* #66 = 0x42 */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/8192.bin" } },
    /* #67 = 0x43 */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 6932 } },
    /* #68 = 0x44 */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/8192.bin", O_RDONLY, 0 } },
    ...
    /* #75 = 0x4b */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/256.bin" } },
    /* #76 = 0x4c */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 8187 } },
    /* #77 = 0x4d */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/256.bin", O_RDONLY, 0 } },
    ...
    /* #85 = 0x55 */ { .opcode = FSTATAT_OP, .args.fstatat = { 0, "/fstrace/tar/2048.bin" } },
    /* #86 = 0x56 */ { .opcode = WAITUNTIL_OP, .args.waituntil = { 0, 6687 } },
    /* #87 = 0x57 */ { .opcode = OPEN_OP, .args.open = { 5, "/fstrace/tar/2048.bin", O_RDONLY, 0 } },
